## Практическая работа № 6 (Программирование корпоративных систем)
...
3) Нас траницу "Об игре" тоже добавила кнопку "Добавить в корзину", работающую по такому же принципу. А также внизу страницы добавлена кнопка "Удалить игру".
