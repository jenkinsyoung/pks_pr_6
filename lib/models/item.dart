class Item{
  ...
  Item(this.title, this.image, this.description,
      this.rules, this.age, this.gamers,  this.time, this.price,
      this.indicator);

  void changeFavorite(Item element){
    if (favorite.contains(element)) {
      favorite.remove(element);
    }
    else{
...
List<Item> games = [
  Item( 'Бункер', 'https://rolethedice.ru/wp-content/uploads/2021/02/%D0%A8%D0%B0%D0%B1%D0%BB%D0%BE%D0%BD2-6-1024x705.jpg',
    '"Бункер" – спасение за пределами возможностей!',
    ...
    18, "4-16 игроков", "30-60 минут", 2990, 1
  ),
  Item('Ужас Аркхэма',
    'https://22games.net/wp-content/uploads/2024/07/The-Dream-Eaters-Investigator-Expansion-1.jpg',
    "Два мира, две древние силы – и только вы стоите между ними.",
    ...
    13, "1-4 игрока", "1-2 часа", 4490, 2),
  Item( 'Descent',
    'https://22games.net/wp-content/uploads/2023/10/Descent-Legends-of-the-Dark-The-Betrayers-War-11.jpg',
    "Драконы, мятеж и древние враги – будущее Терринота под угрозой.",
    ...
    13, "1-4 игрока", "3-4 часа", 17990, 3),
  Item('Манчкин',
    'https://belosnejka52.ru/image/cache/data/products/razvivayushchieigrushkiknigi/nastolniedidakticheskieigri/9/FaXwcdvsErc-600x600-600x600.jpg',
    'В мире "Манчкин" дружба и предательство идут рука об руку!',
  ...
  Item('Неудержимые единорожки',
    ...
    12, "2-8 игроков", "30-60 минут", 1290, 2),
  Item('Игра UNO',
    'https://um-detki.ru/wp-content/uploads/2019/03/uno3.jpg',
    'В этой маленькой коробочке притаилось большое веселье!',
    ...
    7, "2-10 игроков", "15-45 минут", 790, 3),
  Item('Мафия: Вся семья в сборе',
    'https://avatars.mds.yandex.net/get-mpic/5231998/2a0000018e2424cb5a1f0eb06e85c1e4bc2d/orig',
    '"Мафия" – классика психологических игр!',
    ...
    14, "7-17 игроков", "20+ минут", 2490, 1),
];
List<Item> favorite = [];
List<Item> basket = [];
